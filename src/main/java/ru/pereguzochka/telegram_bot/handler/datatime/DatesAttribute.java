...
@Getter
@Setter
@ConfigurationProperties(prefix = "attr.dates")
@RequiredArgsConstructor
public class DatesAttribute extends BaseAttribute {
    ...
    public InlineKeyboardMarkup generateDatesMarkup(List<TimeSlotDto> timeslots, int next) {
    ...
    private List<List<InlineKeyboardButton>> createNextWeekButtons(List<TimeSlotDto> timeslots, int next) {
