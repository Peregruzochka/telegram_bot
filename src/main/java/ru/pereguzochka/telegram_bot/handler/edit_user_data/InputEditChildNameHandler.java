...
public class InputEditChildNameHandler implements UpdateHandler {
    ...
    public boolean isApplicable(Update update) {
        ...
        boolean value = inputEditChildNameByTelegramId.isTrue(telegramId);
    ...
    public void compute(Update update) {
        String telegramId = telegramBot.extractTelegramId(update).toString();
        inputEditChildNameByTelegramId.setFalse(telegramId);
        ...
        String editChildName = update.getMessage().getText();
        if (editChild.getStatus().equals(REGULAR)) {
            editChild.setStatus(EDITING);
        }
        editChild.setName(editChildName);
