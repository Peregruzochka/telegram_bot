...
public class CancelHandler implements UpdateHandler {
    ...
    public void compute(Update update) {
        ...
        String text = cancelChooseRegistrationAttribute.generateCancelText(registrations);
        InlineKeyboardMarkup markup = cancelChooseRegistrationAttribute.generateCancelMarkup(registrations);
